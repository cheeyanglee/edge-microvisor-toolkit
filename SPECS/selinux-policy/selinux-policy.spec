...
Patch36:        0036-rasdaemon-Fix-var_lib_t-failurs.patch
Patch37:        0036-fstools-Add-additional-perms-for-cloud-utils-growpar.patch
Patch38:        0037-docker-Fix-dockerc-typo-in-container_engine_executab.patch
Patch39:        0037-bootloader-allow-to-create-dirs.patch
Patch40:        0038-Fix-rsyslogd-selinux-permission-denied.patch
Patch41:        0039-Fix-cloud-init-selinux-permission-denied.patch
Patch42:        0040-Fix-loadkeys-shell-process-selinux-permission-denied.patch
Patch43:        0041-Fix-multipath-selinux-permision-denied.patch
Patch44:        0042-Fix-systemd-selinux-permission-denied.patch
Patch45:        0043-Fix-systemd-udevd-selinux-permission-denied.patch
Patch46:        0044-Fix-getty-selinux-permission-denied.patch
Patch47:        0045-Fix-init-selinux-permission-denied.patch
Patch48:        0046-Fix-modutils-selinux-permission-denied.patch
Patch49:        0047-Fix-cryptsetup-selinux-permission-denied.patch
Patch50:        0048-Fix-dbus-selinux-permission-denied.patch
Patch51:        0049-Fix-tpm2_abrmd-selinux-permission-denied.patch
...
* Tue Jan 21 2024 Tan Jia Yong <jia.yong.tan@intel.com> - 2.20240226-16
- Update SELinux policy on cloud-init patch.

* Fri Jan 10 2024 Tan Jia Yong <jia.yong.tan@intel.com> - 2.20240226-15
- Add new fix to cloud-init patch.
- Add fix for fsadm.
- Add fix to ntpd.

* Thu Dec 19 2024 Mun Chun Yep <mun.chun.yep@intel.com> - 2.20240226-14
- Update vendor and distribution tag.

* Thu Nov 28 2024 Tan Jia Yong <jia.yong.tan@intel.com> - 2.20240226-13
- Add fix for systemd-analyze.
- Add fix for systemd-logind.
- Add fix for systemd-pcrphase.
- Add fix for systemd-networkd.
- Add fix for getty.
- Add fix for init
- Add fix for modutils.
- Add fix for cryptsetup
- Add fix for system_dbusd

* Mon Nov 04 2024 Ranjan Dutta <ranjan.dutta@intel.com> - 2.20240226-12
- Bump up version number for rebase to latest AZL 3.0.20241030-3.0
- Refresh Patch.

* Thu Oct 24 2024 Tan Jia Yong <jia.yong.tan@intel.com> - 2.20240226-11
- Add fix for systemd-udevd.
- Add fix for systemd-machine-id-setup.
- Add fix for systemd-pcrphase.
- Add fix for systemd-tmpfiles.
- Add fix for multipath.
- Add fix for loadkeys shell process.

* Tue Oct 22 2024 Tan Jia Yong <jia.yong.tan@intel.com> - 2.20240226-10
- Add fix for cloud-init.

* Tue Oct 22 2024 Tan Jia Yong <jia.yong.tan@intel.com> - 2.20240226-9
- Add fix for rsyslogd.

* Thu Oct 17 2024 Naveen Saini <naveen.kumar.saini@intel.com> - 2.20240226-8
- Add fix for bootloader.

* Tue Oct 15 2024 Tan Jia Yong <jia.yong.tan@intel.com> - 2.20240226-7
- Add fix for rasdaemon.
