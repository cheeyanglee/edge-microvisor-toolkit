...
%if (0%{?fedora} >= 38 || 0%{?rhel} >= 10) && !0%{?emt}
...
* Fri Oct 3 2025 Lee Chee Yang <chee.yang.lee@intel.com> - 20240524git3e722403cd16-10
- merge from Azure Linux 3.0.20250910-3.0
- Patch for CVE-2025-3770

* Tue Sep 30 2025 Andy <andy.peng@intel.com> - 20240524git3e722403cd16-9
