...
%changelog
* Mon Feb 23 2026 Lee Chee Yang <chee.yang.lee@intel.com> - 1.4.0-5
- merge from Azure Linux 3.0.20260204-3.0
- Patch for CVE-2025-65637

* Fri May 30 2025 Ranjan Dutta <ranjan.dutta@intel.com> - 1.4.0-4
- merge from Azure Linux 3.0.20250521-3.0
- Patch CVE-2025-22872

* Fri Mar 21 2025 Anuj Mittal <anuj.mittal@intel.com> - 1.4.0-3
